...
public:
    ...
    void setupUi(QMainWindow *MapSensor)
    {
        ...
        lbSensor->setGeometry(QRect(40, 80, 71, 16));
        QFont font1;
        ...
        lneSubespecie->setGeometry(QRect(150, 210, 261, 22));
        ...
        lneInvestigador->setGeometry(QRect(160, 250, 251, 21));
        ...
        lneZona->setGeometry(QRect(90, 290, 321, 21));
        ...
        lneMunicipio->setGeometry(QRect(120, 330, 291, 22));
        ...
        lneEstado->setGeometry(QRect(100, 370, 311, 22));
